...
bj = game.Game(num_players=1, min_bet=100, rules=bj_rules.VegasRules, used_hands=20, always_shuffle=True)
bj.start(epoch=10, rounds=50000)
...
# surrender
#
# implement auto strategic play
# Json performance logger
# evolving player
